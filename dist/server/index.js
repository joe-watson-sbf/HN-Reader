globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/router-UpL-bLP8.js","assets/worker-entry-BlAyvNEg.js"];
...
async function POST(request) {
  ...
  const newIds = isBookmarked ? currentIds.filter((i) => i !== id) : [...currentIds, id];
...
async function getBookmarkedIds() {
  ...
  if (!cookie?.value) return /* @__PURE__ */ new Set();
  try {
...
async function RootLayout({
  ...
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("html", { lang: "en", suppressHydrationWarning: true, className: "font-sans", children: /* @__PURE__ */ jsxRuntime_reactServerExports.jsx(
    "body",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime_reactServerExports.jsx(BookmarkProvider, { initialIds: [...ids], children })
    }
  ) });
}
...
const Nav = /* @__PURE__ */ registerClientReference(() => {
  throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "3e58ca9e5ef5", "default");
const BookmarksContent = /* @__PURE__ */ registerClientReference(() => {
  throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "d149ae9643a0", "default");
const metadata$1 = {
...
function BookmarksPage() {
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "min-h-screen bg-zinc-950 text-zinc-100", children: [
    ...
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("main", { className: "max-w-3xl mx-auto px-4 py-8", children: [
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntime_reactServerExports.jsx("h1", { className: "text-xl font-semibold text-white", children: "Bookmarks" }) }),
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsx(BookmarksContent, {})
    ] })
  ] });
}
    ...
    /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("main", { className: "max-w-3xl mx-auto px-4 py-8", children: [
      ...
      /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("article", { className: "bg-zinc-900 border border-zinc-800 rounded-xl p-6 mb-6", children: [
        /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "flex items-start gap-3 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntime_reactServerExports.jsx(BookmarkButton, { id: story.id })
        ] }),
...
async function StoryFeed({
  ...
  return /* @__PURE__ */ jsxRuntime_reactServerExports.jsxs("div", { className: "space-y-3", children: [
    filtered.map((story, i) => /* @__PURE__ */ jsxRuntime_reactServerExports.jsx(StoryCard, { story, rank: i + 1 }, story.id)),
