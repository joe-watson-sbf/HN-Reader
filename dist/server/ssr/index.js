...
const clientReferences = {
  "d149ae9643a0": async () => {
    const m = await import("./assets/worker-entry-DBVXv5w9.js");
    return m.export_d149ae9643a0;
  },
  "d6422401ef32": async () => {
    const m = await import("./assets/worker-entry-DBVXv5w9.js");
    return m.export_d6422401ef32;
  },
  "eccf7c8dc7d4": async () => {
    const m = await import("./assets/worker-entry-DBVXv5w9.js");
    return m.export_eccf7c8dc7d4;
  },
  "3e58ca9e5ef5": async () => {
    const m = await import("./assets/worker-entry-DBVXv5w9.js");
    return m.export_3e58ca9e5ef5;
  },
  "6451b87f0574": async () => {
    const m = await import("./assets/worker-entry-DBVXv5w9.js");
    return m.export_6451b87f0574;
  },
  "a9bbde40cf2d": async () => {
    const m = await import("./assets/worker-entry-DBVXv5w9.js");
    return m.export_a9bbde40cf2d;
  },
  "f29e6e234fea": async () => {
    const m = await import("./assets/worker-entry-DBVXv5w9.js");
...
async function handleSsr(rscStream, navContext, fontData) {
  return runWithNavigationContext(async () => {
    ...
    try {
      ...
      const { createElement, Fragment } = await Promise.resolve().then(() => index);
      let insertedHTML = "";
